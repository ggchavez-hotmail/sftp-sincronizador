...
class Tareas():
    ...
    def recuperar_casillas(self):
        ...
        self.db = Db_Options(self.params.DBCONEXION,
                             self.params.DBNAME, self.params.DBCLLPARAMS)
    ...
    def ListOrigen(self):
        ...
        if (casillas != None):
            ...
            for casilla in casillas:
                ...
                resultado = sftp.listdir_attr(casilla["local_list_path"])
                ...
                if (sftp.cod_status == 0):
                    if (resultado != None):
                        for item in resultado:
                            ...
                            count_documents = db.count_documents_by_item(
                                item_buscar)
    ...
    def GetOrigen(self):
        ...
        if (casillas != None):
            ...
            for casilla in casillas:
                ...
                db = Db_Options(self.params.DBCONEXION,
                                self.params.DBNAME, self.params.DBCLLJOURNAL)
                ...
                if (existe_item_en_db != None):
                    ...
                    existe_item_en_db.sort(key=lambda x: (
                        x["st_mtime"], -x["prioridad"]))
                ...
                if (sftp.cod_status == 0):
                    if (resultado != None):
                        for item in resultado:
                            ...
                            item_buscar = {"$and": [
                                {"file_name": f"{item[0]}", "casilla": casilla["_id"],
                                    "operacion": f"{self.proceso}"},
                                {"estado": {"$nin": ["eliminar", "eliminado"]}}
                            ]}
